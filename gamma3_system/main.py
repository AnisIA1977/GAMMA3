...
def create_series_bulk(constructor_id: int, series_list: List[schemas.SeriesCreate], db: Session = Depends(get_db)):
    return crud.create_series_bulk(db=db, series_list=series_list, constructor_id=constructor_id)
